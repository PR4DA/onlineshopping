...
public class FileUtil {
    ...
    public static void uploadNoImage(HttpServletRequest request, String code) {
        ...
        try {
            ...
            try (InputStream is = url.openStream(); OutputStream osREAL_PATH = new FileOutputStream(destinationServerFile); OutputStream osABS_PATH = new FileOutputStream(destinationProjectFile);) {
