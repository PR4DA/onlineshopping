...
/*
	...
	public void testAddUser() {
		...
		address = new Address();
		address.setAddressLineOne("101 djsabdhjas, jaLXNKa");
		address.setAddressLineTwo("zzzzz");
		address.setCity("Mumbai");
		address.setState("sss");
		address.setCountry("njsak");
		...
		address = new Address();
		address.setAddressLineOne("201 djsabdhjas, jaLXNKa");
		address.setAddressLineTwo("zzzzz");
		address.setCity("Mumbai");
		address.setState("sss");
		address.setCountry("njsak");
...
/*
	...
	public void testAddAddress() {
		...
		address = new Address();
		address.setAddressLineOne("301 djsabdhjas, jaLXNKa");
		address.setAddressLineTwo("zzzzz");
		address.setCity("Mumbai");
		address.setState("njsak");
		address.setCountry("njsak");
		address.setPostalCode("400001");
